//
//  PhotoAlbumExtensions.swift
//  Sconce
//
//  Created by Pandiyaraj on 23/01/18.
...
extension PHPhotoLibrary {
    ...
    class func savePhoto(image:UIImage, albumName:String, completion:((PHAsset?)->())? = nil) {
        func save() {
