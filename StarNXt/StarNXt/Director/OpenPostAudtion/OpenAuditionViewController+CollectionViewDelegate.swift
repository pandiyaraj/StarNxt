//
//  OpenAuditionViewController+CollectionViewDelegate.swift
//  StarNXt
//
...
extension OpenAuditionViewController : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == knownLanguageCollectionView{
            ...
            cell.collectionBtn.setTitle(self.projectListArray[indexPath.row], for: .normal)
            cell.collectionBtn.addTarget(self, action: #selector(projectSelectAction(sender:)), for: .touchUpInside)
        }else{
