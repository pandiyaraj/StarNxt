...
public extension String {
    ...
    var sessionId : String {
        let fileNameObj = self.components(separatedBy: "_")
        if fileNameObj.count > 0 {
            let sessionId = fileNameObj.first
            return sessionId!
        }else{
            return ""
        }
    ...
    public func toUSPhoneNumber() -> String {
        let usMobileNo = self.replacingOccurrences(of: "(\\d{3})(\\d{3})(\\d+)", with: "$1-$2-$3", options: .regularExpression, range: nil)
        return "(+1)\(usMobileNo)"
    }
...
public extension String {
    ...
    public func getImageName() -> String{
        if UIDevice().userInterfaceIdiom == .phone {
            ...
            case 1136:
                return "\(self)_640 x 1136.png"
            case 1334:
                return "\(self)_750 x 1334.png"
            case 1920:
                return "\(self)_1242 x 2208.png"
//                return "\(self)_1080 x 1920.png"
            case 2208:
                return "\(self)_1242 x 2208.png"
            case 2436:
                return "\(self)_1125 x 2436.png"
            default:
                return "\(self)_640 x 960.png"
            }
        }else{
            return "\(self)_1242 x 2208.png"
        }
    }
    public func getImageSize() -> String{
        if UIDevice().userInterfaceIdiom == .phone {
            switch UIScreen.main.nativeBounds.height {
            case 1136:
                return "640X1136"
...
extension CGFloat {
    func roundOfToNearestGreaterValue() {
